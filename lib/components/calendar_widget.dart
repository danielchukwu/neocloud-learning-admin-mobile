...
class _CalendarWidgetState extends State<CalendarWidget> {
  ...
  void initState() {
    ...
    calendarYears = calendar.getMultipleCalendarYearData(now.year-1, now.year+1);
    int yearHeight = 3900;  // calendar year height
    int skipYear = yearHeight * 1;
    double monthHeightPercentage = .083;
    _scrollController = ScrollController(initialScrollOffset: skipYear + yearHeight * (monthHeightPercentage * ((now.month - 1))));
                    ...
                    children: [
                      ...
                      GridView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          DateSelection dateSelection = DateSelection(year: calendarYear.year, month: monthIndex + 1, day: day);
                          bool dateIsSelected = _dateSelected != null && DateSelection.compareDateSelection(_dateSelected!, dateSelection);
